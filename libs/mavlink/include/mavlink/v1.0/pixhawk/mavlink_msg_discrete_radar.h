...
#define MAVLINK_MSG_ID_DISCRETE_RADAR 199
...
#define MAVLINK_MSG_ID_199_LEN 78

#define MAVLINK_MSG_ID_DISCRETE_RADAR_CRC 85
#define MAVLINK_MSG_ID_199_CRC 85
						       ...
						       uint64_t time_usec, uint8_t sensor_id, const int16_t *distances, float sonar, uint8_t quality)
{
	...
	char buf[MAVLINK_MSG_ID_DISCRETE_RADAR_LEN];
	...
	_mav_put_int16_t_array(buf, 12, distances, 32);
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), buf, MAVLINK_MSG_ID_DISCRETE_RADAR_LEN);
#else
	...
	mav_array_memcpy(packet.distances, distances, sizeof(int16_t)*32);
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), &packet, MAVLINK_MSG_ID_DISCRETE_RADAR_LEN);
#endif

	msg->msgid = MAVLINK_MSG_ID_DISCRETE_RADAR;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_DISCRETE_RADAR_LEN, MAVLINK_MSG_ID_DISCRETE_RADAR_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_DISCRETE_RADAR_LEN);
#endif
}
						           ...
						           uint64_t time_usec,uint8_t sensor_id,const int16_t *distances,float sonar,uint8_t quality)
{
	...
	msg->msgid = MAVLINK_MSG_ID_DISCRETE_RADAR;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_DISCRETE_RADAR_LEN, MAVLINK_MSG_ID_DISCRETE_RADAR_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_DISCRETE_RADAR_LEN);
#endif
}
...
static inline void mavlink_msg_discrete_radar_send(mavlink_channel_t chan, uint64_t time_usec, uint8_t sensor_id, const int16_t *distances, float sonar, uint8_t quality)
{
	...
	_mav_put_int16_t_array(buf, 12, distances, 32);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DISCRETE_RADAR, buf, MAVLINK_MSG_ID_DISCRETE_RADAR_LEN, MAVLINK_MSG_ID_DISCRETE_RADAR_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DISCRETE_RADAR, buf, MAVLINK_MSG_ID_DISCRETE_RADAR_LEN);
#endif
#else
	mavlink_discrete_radar_t packet;
	packet.time_usec = time_usec;
	...
	mav_array_memcpy(packet.distances, distances, sizeof(int16_t)*32);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DISCRETE_RADAR, (const char *)&packet, MAVLINK_MSG_ID_DISCRETE_RADAR_LEN, MAVLINK_MSG_ID_DISCRETE_RADAR_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DISCRETE_RADAR, (const char *)&packet, MAVLINK_MSG_ID_DISCRETE_RADAR_LEN);
#endif
#endif
}
...
#else
	memcpy(discrete_radar, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_DISCRETE_RADAR_LEN);
#endif
}
